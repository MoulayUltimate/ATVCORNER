...
export const leagueExtras: Record<string, LocalizedExtras> = {
  "premier-league": {
    ...
    es: {
      intro: "Ver la Premier League en HD y 4K desde cualquier país europeo se ha convertido en un rompecabezas: Sky Sports en el Reino Unido, Canal+ en Francia, Sky Deutschland en Alemania, DAZN en Italia y Movistar en España. Cada emisora oficial impone un bloqueo geográfico estricto y una suscripción aparte. ATV Corner reúne el campeonato inglés completo —Manchester United, Liverpool, Arsenal, Chelsea, Manchester City, Tottenham, Newcastle, Aston Villa y West Ham— en una sola aplicación accesible en toda Europa.",
      sections: [
        { h2: "Calendario de la Premier League 2025/2026: 380 partidos en directo", body: "El campeonato inglés va de agosto a mayo, con 38 jornadas y 380 partidos en total. Cada club juega 19 encuentros en casa y 19 fuera. Los horarios se concentran en el fin de semana (sábado a las 12:30, 15:00 y 17:30, y domingo a las 14:00 y 16:30, hora británica), con partidos habituales el lunes y el viernes por la noche. ATV Corner emite el 100 % de los encuentros en directo, incluida la franja de las 15:00 del sábado, bloqueada en el Reino Unido pero disponible a través de las señales europeas." },
        { h2: "Los Big Six y los derbis históricos de la Premier League", body: "Los seis grandes —Manchester United, Liverpool, Arsenal, Chelsea, Manchester City y Tottenham— concentran la atención mundial. Los derbis imprescindibles: el de Manchester (City contra United), el de Merseyside (Liverpool contra Everton), el del norte de Londres (Arsenal contra Tottenham), el de Londres (Chelsea contra Tottenham) y el llamado El Cashico (Manchester City contra Arsenal). ATV Corner emite todos los grandes choques en 4K HDR con multicámara y comentarios en español, inglés, francés, alemán y árabe." },
        { h2: "La Premier League en 4K y HDR en ATV Corner", body: "El campeonato inglés se emite en 4K nativo desde 2023. Sky UK y TNT Sports ofrecen el Super Sunday, el Monday Night Football y los grandes partidos en Ultra HD con HDR. ATV Corner retransmite esas señales 4K UHD HDR10 y las pone a disposición en Smart TV Samsung, LG y Sony, Apple TV 4K, Fire TV Stick 4K Max, NVIDIA Shield Pro y box Android TV compatibles." },
        { h2: "Cómo ver la Premier League en directo desde el extranjero", body: "Para seguir la Premier League desde España, Francia, Bélgica, Alemania o Suiza existen tres opciones: (1) una suscripción oficial local (Canal+, Sky Deutschland, DAZN, Movistar) que solo cubre una parte de los partidos y sigue estando geobloqueada; (2) una VPN combinada con Sky UK o Peacock, cara e inestable; (3) una suscripción de ATV Corner que agrega todas las emisoras europeas en una sola interfaz, sin VPN, sin bloqueo geográfico y con un precio único desde 15 € al mes." },
        { h2: "La Premier League en móvil, Smart TV, Fire Stick y Apple TV", body: "ATV Corner emite la Premier League en todos los dispositivos: Smart TV Samsung Tizen y LG WebOS mediante Smarters Pro o IBO Player, Fire TV Stick 4K Max con TiviMate, Apple TV mediante Smarters Pro, box Android TV (Xiaomi Mi Box, Chromecast con Google TV, NVIDIA Shield), iPhone y iPad con iOS, móviles Android, PC con Windows, macOS y navegadores Chrome, Safari y Firefox." },
      ],
      broadcasters: [
        { name: "ATV Corner", coverage: "100 % de los 380 partidos", price: "15 €/mes", note: "Todas las señales europeas y 4K HDR" },
        { name: "Canal+ Foot (FR)", coverage: "Selección (unos 6 partidos por jornada)", price: "29 €/mes", note: "Geobloqueado solo en Francia" },
        { name: "Sky Sports (UK)", coverage: "Salvo el bloqueo de las 15:00 del sábado", price: "36 £/mes", note: "Geobloqueado en el Reino Unido y requiere Sky Q" },
        { name: "Sky Deutschland", coverage: "Selección (unos 5 partidos por jornada)", price: "30 €/mes", note: "Geobloqueado en Alemania y Austria" },
        { name: "DAZN Italia", coverage: "Todos los partidos", price: "35 €/mes", note: "Geobloqueado en Italia" },
        { name: "Peacock (US)", coverage: "Todos los partidos", price: "12 $/mes", note: "Geobloqueado en Estados Unidos, requiere VPN" },
      ],
      byDevice: [
        { device: "Smart TV Samsung y LG", how: "Instala Smarters Pro desde la tienda oficial, introduce tus credenciales de ATV Corner y elige el canal de la Premier League." },
        { device: "Fire TV Stick 4K Max", how: "Descarga TiviMate mediante Downloader, importa la lista M3U facilitada por ATV Corner y abre el partido en 4K HDR." },
        { device: "Apple TV 4K", how: "Instala Smarters Pro desde la App Store, conéctate con tus credenciales Xtream y accede al instante a todos los canales del Reino Unido, Francia y Alemania." },
        { device: "Android TV y NVIDIA Shield", how: "Instala TiviMate Premium, añade tu lista y activa el mosaico multivisión para seguir varios partidos de la Premier a la vez." },
        { device: "iPhone y Android", how: "Aplicación móvil de Smarters Pro, con Chromecast o AirPlay hacia el televisor: perfecto para seguir al Manchester United desde cualquier sitio." },
      ],
      extraFaq: [
        { q: "¿Lleva ATV Corner todos los canales de la Premier League?", a: "Sí: Sky Sports Premier League, TNT Sports, Canal+ Foot, Sky Deutschland, DAZN Italia, Movistar y beIN Sports. Todos los canales que emiten la Premier League están incluidos." },
        { q: "¿Puedo ver el Manchester United contra el Liverpool desde Madrid?", a: "Sí, sin VPN ni restricción geográfica. ATV Corner agrega las señales europeas, así que tienes Sky Sports UK desde España con comentarios en español disponibles en paralelo." },
        { q: "¿Está la Premier League disponible en el Fire TV Stick?", a: "Sí, ATV Corner funciona en Fire TV Stick de todas las generaciones, Fire TV Cube y Fire TV Stick 4K y 4K Max mediante TiviMate, Smarters Pro o IBO Player." },
        { q: "¿Cuánto cuesta una suscripción de ATV Corner para ver la Premier League?", a: "Desde 15 €/mes en Essential (HD), 22 €/mes en Premium (4K HDR y multipantalla) y 30 €/mes en Elite (4K, videoteca y multicámara)." },
        { q: "¿Hay retardo respecto a Sky Sports UK?", a: "El retardo medio es de 15 a 25 segundos, equivalente al de las aplicaciones oficiales de Sky Go, DAZN o Canal+." },
        { q: "¿Puedo grabar partidos de la Premier League?", a: "Sí, mediante la función de repetición de 7 días. Los partidos quedan disponibles bajo demanda cuando termina la emisión en directo." },
        { q: "¿Qué velocidad necesito para la Premier League en 4K?", a: "Un mínimo de 25 Mbps de bajada para un 4K HDR estable; con 8 Mbps basta para HD 1080p. Comprueba tu ancho de banda con nuestra herramienta." },
        { q: "¿Emite ATV Corner también la FA Cup y la Carabao Cup?", a: "Sí, las copas inglesas (FA Cup, Copa de la Liga y Community Shield) están incluidas en la suscripción, en directo y en repetición." },
      ],
      related: [
        { label: "Ver al Manchester United", href: "/tools/team/manchester-united" },
        ...
        { label: "La Premier League en Fire Stick", href: "/tools/device-compatibility" },
      ],
    },
    it: {
      intro: "Guardare la Premier League in HD e 4K da qualsiasi paese europeo è diventato un rompicapo: Sky Sports nel Regno Unito, Canal+ in Francia, Sky Deutschland in Germania, DAZN in Italia e Movistar in Spagna. Ogni emittente ufficiale impone un blocco geografico rigido e un abbonamento separato. ATV Corner riunisce l'intero campionato inglese — Manchester United, Liverpool, Arsenal, Chelsea, Manchester City, Tottenham, Newcastle, Aston Villa e West Ham — in un'unica applicazione accessibile in tutta Europa.",
      sections: [
        { h2: "Calendario della Premier League 2025/2026: 380 partite in diretta", body: "Il campionato inglese va da agosto a maggio, con 38 giornate e 380 partite in totale. Ogni club gioca 19 incontri in casa e 19 in trasferta. Gli orari si concentrano nel fine settimana (sabato alle 12:30, 15:00 e 17:30, domenica alle 14:00 e 16:30, ora britannica), con partite abituali il lunedì e il venerdì sera. ATV Corner trasmette il 100 % degli incontri in diretta, compresa la fascia delle 15:00 del sabato, oscurata nel Regno Unito ma disponibile tramite i segnali europei." },
        { h2: "I Big Six e i derby storici della Premier League", body: "I sei grandi — Manchester United, Liverpool, Arsenal, Chelsea, Manchester City e Tottenham — concentrano l'attenzione mondiale. I derby imperdibili: quello di Manchester (City contro United), quello del Merseyside (Liverpool contro Everton), quello del nord di Londra (Arsenal contro Tottenham), quello di Londra (Chelsea contro Tottenham) e il cosiddetto Cashico (Manchester City contro Arsenal). ATV Corner trasmette tutti i grandi scontri in 4K HDR con multicamera e telecronaca in italiano, inglese, francese, tedesco e arabo." },
        { h2: "La Premier League in 4K e HDR su ATV Corner", body: "Il campionato inglese viene trasmesso in 4K nativo dal 2023. Sky UK e TNT Sports offrono il Super Sunday, il Monday Night Football e le partite di cartello in Ultra HD con HDR. ATV Corner ritrasmette quei segnali 4K UHD HDR10 e li rende disponibili su Smart TV Samsung, LG e Sony, Apple TV 4K, Fire TV Stick 4K Max, NVIDIA Shield Pro e box Android TV compatibili." },
        { h2: "Come guardare la Premier League in diretta dall'estero", body: "Per seguire la Premier League dall'Italia, dalla Francia, dal Belgio, dalla Germania o dalla Svizzera esistono tre opzioni: (1) un abbonamento ufficiale locale (DAZN, Sky, Canal+) che copre solo una parte delle partite e resta bloccato geograficamente; (2) una VPN abbinata a Sky UK o Peacock, costosa e instabile; (3) un abbonamento ATV Corner che aggrega tutte le emittenti europee in un'unica interfaccia, senza VPN, senza blocco geografico e con un prezzo unico da 15 € al mese." },
        { h2: "La Premier League su telefono, Smart TV, Fire Stick e Apple TV", body: "ATV Corner trasmette la Premier League su tutti i dispositivi: Smart TV Samsung Tizen e LG WebOS tramite Smarters Pro o IBO Player, Fire TV Stick 4K Max con TiviMate, Apple TV tramite Smarters Pro, box Android TV (Xiaomi Mi Box, Chromecast con Google TV, NVIDIA Shield), iPhone e iPad con iOS, telefoni Android, PC Windows, macOS e browser Chrome, Safari e Firefox." },
      ],
      broadcasters: [
        { name: "ATV Corner", coverage: "100 % delle 380 partite", price: "15 €/mese", note: "Tutti i segnali europei e 4K HDR" },
        { name: "Canal+ Foot (FR)", coverage: "Selezione (circa 6 partite a giornata)", price: "29 €/mese", note: "Bloccato geograficamente alla sola Francia" },
        { name: "Sky Sports (UK)", coverage: "Escluso l'oscuramento delle 15:00 del sabato", price: "36 £/mese", note: "Bloccato nel Regno Unito e richiede Sky Q" },
        { name: "Sky Deutschland", coverage: "Selezione (circa 5 partite a giornata)", price: "30 €/mese", note: "Bloccato in Germania e Austria" },
        { name: "DAZN Italia", coverage: "Tutte le partite", price: "35 €/mese", note: "Bloccato in Italia" },
        { name: "Peacock (US)", coverage: "Tutte le partite", price: "12 $/mese", note: "Bloccato negli Stati Uniti, richiede VPN" },
      ],
      byDevice: [
        { device: "Smart TV Samsung e LG", how: "Installa Smarters Pro dallo store ufficiale, inserisci le tue credenziali ATV Corner e scegli il canale della Premier League." },
        { device: "Fire TV Stick 4K Max", how: "Scarica TiviMate tramite Downloader, importa la playlist M3U fornita da ATV Corner e avvia la partita in 4K HDR." },
        { device: "Apple TV 4K", how: "Installa Smarters Pro dall'App Store, collegati con le tue credenziali Xtream e accedi all'istante a tutti i canali di Regno Unito, Francia e Germania." },
        { device: "Android TV e NVIDIA Shield", how: "Installa TiviMate Premium, aggiungi la tua playlist e attiva il mosaico multivisione per seguire più partite di Premier insieme." },
        { device: "iPhone e Android", how: "App mobile Smarters Pro, con Chromecast o AirPlay verso il televisore: perfetto per seguire il Manchester United ovunque." },
      ],
      extraFaq: [
        { q: "ATV Corner porta tutti i canali della Premier League?", a: "Sì: Sky Sports Premier League, TNT Sports, Canal+ Foot, Sky Deutschland, DAZN Italia, Movistar e beIN Sports. Tutti i canali che trasmettono la Premier League sono inclusi." },
        { q: "Posso guardare Manchester United contro Liverpool da Milano?", a: "Sì, senza VPN né restrizioni geografiche. ATV Corner aggrega i segnali europei, quindi hai Sky Sports UK dall'Italia con telecronaca in italiano disponibile in parallelo." },
        { q: "La Premier League è disponibile su Fire TV Stick?", a: "Sì, ATV Corner funziona su Fire TV Stick di tutte le generazioni, Fire TV Cube e Fire TV Stick 4K e 4K Max tramite TiviMate, Smarters Pro o IBO Player." },
        { q: "Quanto costa un abbonamento ATV Corner per guardare la Premier League?", a: "Da 15 €/mese con Essential (HD), 22 €/mese con Premium (4K HDR e multischermo) e 30 €/mese con Elite (4K, videoteca e multicamera)." },
        { q: "C'è un ritardo rispetto a Sky Sports UK?", a: "Il ritardo medio è di 15-25 secondi, equivalente a quello delle app ufficiali Sky Go, DAZN o Canal+." },
        { q: "Posso registrare le partite della Premier League?", a: "Sì, tramite la funzione di replay di 7 giorni. Le partite restano disponibili on demand al termine della diretta." },
        { q: "Che velocità serve per la Premier League in 4K?", a: "Almeno 25 Mbps in download per un 4K HDR stabile; con 8 Mbps basta per l'HD 1080p. Verifica la tua banda con il nostro strumento." },
        { q: "ATV Corner trasmette anche FA Cup e Carabao Cup?", a: "Sì, le coppe inglesi (FA Cup, Coppa di Lega e Community Shield) sono incluse nell'abbonamento, in diretta e in replay." },
      ],
      related: [
        { label: "Guarda il Manchester United", href: "/tools/team/manchester-united" },
        ...
        { label: "La Premier League su Fire Stick", href: "/tools/device-compatibility" },
      ],
    },
  },
};
