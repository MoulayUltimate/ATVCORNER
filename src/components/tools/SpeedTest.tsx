...
const COPY: Partial<Record<Locale, Copy>> = {
  ...
  es: {
    h1: "Test de velocidad para fútbol en directo",
    intro: "Introduce la velocidad de tu conexión en Mbps. La calculadora te dice en qué calidad puedes ver fútbol y cuántas emisiones simultáneas soporta tu línea.",
    labelSpeed: "Tu velocidad de bajada (Mbps)",
    labelStreams: "Número de emisiones simultáneas",
    result: "Resultado",
    recommend: "Calidad recomendada",
    bandwidth: "Ancho de banda mínimo necesario",
    tips: "Consejos para resolver problemas",
    tipsList: [
      "Conecta el aparato principal por cable Ethernet en lugar de wifi",
      "Prefiere la banda de 5 GHz (Wi-Fi 5/6): la de 2,4 GHz está saturada",
      "Pausa las descargas en segundo plano durante un partido en directo",
      "Por debajo de 10 Mbps, desactiva la reproducción automática en HD dentro de la aplicación",
      "Una VPN reduce la velocidad entre un 20 y un 40 %; ATV Corner no la necesita",
    ],
    cta: "Activar la suscripción",
    qualities: [
      { id: "sd", label: "SD (480p)", need: 3, desc: "Cómodo solo en el móvil" },
      { id: "hd", label: "HD (720p)", need: 5, desc: "Smart TV media, multicámara sencilla" },
      { id: "fullhd", label: "Full HD (1080p)", need: 8, desc: "Calidad estándar en 2026 para Smart TV" },
      { id: "4k", label: "4K HDR", need: 25, desc: "Premium: grandes partidos europeos y Champions League" },
      { id: "8k", label: "8K (selección)", need: 50, desc: "Para televisores 8K, con material nativo en 8K" },
    ],
    faq: "Preguntas frecuentes",
    faqItems: [
      { q: "¿Qué ancho de banda para la Premier League en 4K?", a: "25 Mbps de bajada como mínimo, de forma estable. Para dos emisiones 4K en paralelo, por ejemplo dos televisores en casa, cuenta con 40 Mbps." },
      { q: "¿Basta con el wifi?", a: "Sí, con Wi-Fi 5/6 en la banda de 5 GHz y cerca del router. Para un 4K estable, el cable Ethernet sigue siendo preferible." },
      { q: "¿Por qué se corta mi emisión?", a: "Las causas habituales son velocidad insuficiente, wifi saturado o un DNS lento. Cambia de DNS (1.1.1.1 o 8.8.8.8) y activa el QoS en el router." },
      { q: "¿Ayuda una VPN?", a: "Con ATV Corner no, porque no la necesitas. Una VPN frena la conexión sin aportar nada." },
    ],
  },
  it: {
    h1: "Test di velocità per il calcio in diretta",
    intro: "Inserisci la velocità della tua connessione in Mbps. Il calcolatore ti dice in quale qualità puoi guardare il calcio e quante trasmissioni simultanee regge la tua linea.",
    labelSpeed: "La tua velocità in download (Mbps)",
    labelStreams: "Numero di trasmissioni simultanee",
    result: "Risultato",
    recommend: "Qualità consigliata",
    bandwidth: "Banda minima necessaria",
    tips: "Consigli per risolvere i problemi",
    tipsList: [
      "Collega l'apparecchio principale via cavo Ethernet invece che in wifi",
      "Preferisci la banda 5 GHz (Wi-Fi 5/6): quella a 2,4 GHz è congestionata",
      "Metti in pausa i download in background durante una partita in diretta",
      "Sotto i 10 Mbps, disattiva la riproduzione automatica in HD dentro l'app",
      "Una VPN riduce la velocità tra il 20 e il 40 %; ATV Corner non ne ha bisogno",
    ],
    cta: "Attiva l'abbonamento",
    qualities: [
      { id: "sd", label: "SD (480p)", need: 3, desc: "Comodo solo sul telefono" },
      { id: "hd", label: "HD (720p)", need: 5, desc: "Smart TV media, multicamera semplice" },
      { id: "fullhd", label: "Full HD (1080p)", need: 8, desc: "Qualità standard nel 2026 su Smart TV" },
      { id: "4k", label: "4K HDR", need: 25, desc: "Premium: grandi partite europee e Champions League" },
      { id: "8k", label: "8K (selezione)", need: 50, desc: "Per televisori 8K, con materiale nativo in 8K" },
    ],
    faq: "Domande frequenti",
    faqItems: [
      { q: "Quale banda per la Premier League in 4K?", a: "25 Mbps in download come minimo, in modo stabile. Per due trasmissioni 4K in parallelo, per esempio due televisori in casa, calcola 40 Mbps." },
      { q: "Il wifi basta?", a: "Sì, con Wi-Fi 5/6 sulla banda 5 GHz e vicino al router. Per un 4K stabile il cavo Ethernet resta preferibile." },
      { q: "Perché la mia trasmissione si blocca?", a: "Le cause comuni sono velocità insufficiente, wifi congestionato o un DNS lento. Cambia DNS (1.1.1.1 o 8.8.8.8) e attiva il QoS sul router." },
      { q: "Una VPN aiuta?", a: "Con ATV Corner no, perché non ti serve. Una VPN rallenta la connessione senza portare alcun vantaggio." },
    ],
  },
};
