...
const copy = {
  ...
  es: {
    eyebrow: "HERRAMIENTAS DE STREAMING",
    title_a: "Herramientas de ",
    title_accent: "streaming",
    title_b: " ATV Corner",
    intro: "Configurar, comparar y decidir. Herramientas interactivas y guías concretas para sacar el máximo partido a tu suscripción de fútbol.",
    sec_interactive: "Herramientas interactivas",
    sec_leagues: "Ver por liga",
    sec_countries: "Ver por país",
    sec_teams: "Ver por equipo",
    open: "Abrir",
    watch: "Ver",
    sec_about_h2: "Cómo ver fútbol en directo en Europa",
    sec_about_p1: "ATV Corner reúne las cadenas de fútbol europeas —Sky, DAZN, Canal+, beIN Sports, Movistar, RMC Sport, BT/TNT Sports, Amazon Prime Ligue 1— en una sola aplicación, accesible desde España, Francia, Alemania, Austria, Suiza, Bélgica, Italia, Portugal, Países Bajos, Reino Unido y el resto de Europa. Más de 8.000 canales en HD y 4K HDR, con repetición de 7 días, multicámara en los grandes partidos y comentarios en español, inglés, francés, alemán, italiano y árabe.",
    sec_about_p2: "Tanto si quieres seguir la Premier League desde Madrid, LaLiga desde Barcelona, la Champions League desde Valencia o la Bundesliga desde Sevilla, estas herramientas interactivas te ayudan a elegir la configuración adecuada: comprobar el ancho de banda para 4K, verificar la compatibilidad de tu Smart TV o tu Fire Stick, comparar ATV Corner con las suscripciones oficiales (DAZN, Sky, beIN, Canal+, Movistar) y encontrar en el test el plan que encaja con tu perfil de aficionado.",
    sec_faq_h2: "Preguntas frecuentes sobre fútbol en streaming",
    sec_faq: [
      { q: "¿Cuál es el mejor servicio de fútbol en streaming en Europa?", a: "ATV Corner ofrece la cobertura más completa: LaLiga, Premier League, Serie A, Bundesliga, Ligue 1, Champions League, Europa League, Mundial y Eurocopa. Todas las ligas europeas en HD y 4K, sin bloqueo geográfico, desde 15 €/mes. Frente a DAZN (35 €) o Sky (40 €), la opción más barata y más completa." },
      { q: "¿Puedo ver la Premier League en español sin Sky?", a: "Sí. ATV Corner reúne las emisiones de la Premier League incluyendo comentarios en español. Accedes a los 380 partidos de la temporada, incluidos los del sábado a las 15 h que están bloqueados en el Reino Unido, en HD y 4K HDR." },
      { q: "¿Funciona ATV Corner en Smart TV Samsung, LG y Sony, Fire Stick y Apple TV?", a: "Sí: aplicaciones nativas para Smart TV (Smarters Pro, IBO Player), Fire TV Stick 4K Max (TiviMate), Apple TV 4K (Smarters Pro), Android TV (NVIDIA Shield, Xiaomi Mi Box, Chromecast con Google TV), iPhone, Android, Windows, macOS y navegadores Chrome, Safari y Firefox." },
      { q: "¿Qué velocidad de internet hace falta para el fútbol en 4K?", a: "Al menos 25 Mbps de bajada para un 4K HDR estable, 8 Mbps para HD 1080p y 3 Mbps para SD 720p. Comprueba tu ancho de banda con nuestra herramienta para saber qué calidad soporta tu conexión." },
      { q: "¿Puedo ver varios partidos a la vez?", a: "Sí. El modo multivisión (mosaico de cuatro cuadrantes) está disponible en Fire TV Stick, Android TV, NVIDIA Shield y navegador web. Ideal para las noches de Champions League con ocho partidos en paralelo o para la jornada de liga del sábado." },
      { q: "¿Hay garantía de devolución?", a: "Sí, garantía de devolución de 7 días. Además hay una prueba gratuita de 24 horas por WhatsApp para comprobar la calidad del streaming desde tu propia conexión antes de comprar." },
    ],
  },
  it: {
    eyebrow: "STRUMENTI DI STREAMING",
    title_a: "Strumenti di ",
    title_accent: "streaming",
    title_b: " ATV Corner",
    intro: "Configurare, confrontare e decidere. Strumenti interattivi e guide concrete per sfruttare al massimo il tuo abbonamento calcio.",
    sec_interactive: "Strumenti interattivi",
    sec_leagues: "Guarda per campionato",
    sec_countries: "Guarda per paese",
    sec_teams: "Guarda per squadra",
    open: "Apri",
    watch: "Guarda",
    sec_about_h2: "Come guardare il calcio in diretta in Europa",
    sec_about_p1: "ATV Corner riunisce le emittenti calcistiche europee — Sky, DAZN, Canal+, beIN Sports, Movistar, RMC Sport, BT/TNT Sports, Amazon Prime Ligue 1 — in un'unica applicazione, accessibile da Italia, Francia, Germania, Austria, Svizzera, Belgio, Spagna, Portogallo, Paesi Bassi, Regno Unito e dal resto d'Europa. Oltre 8.000 canali in HD e 4K HDR, con replay di 7 giorni, multicamera sulle partite di cartello e telecronaca in italiano, inglese, francese, tedesco, spagnolo e arabo.",
    sec_about_p2: "Che tu voglia seguire la Premier League da Milano, la Serie A da Roma, la Champions League da Torino o la Bundesliga da Napoli, questi strumenti interattivi ti aiutano a scegliere la configurazione giusta: verificare la banda per il 4K, controllare la compatibilità della tua Smart TV o del Fire Stick, confrontare ATV Corner con gli abbonamenti ufficiali (DAZN, Sky, beIN, Canal+, Movistar) e trovare con il quiz il piano adatto al tuo profilo da tifoso.",
    sec_faq_h2: "Domande frequenti sul calcio in streaming",
    sec_faq: [
      { q: "Qual è il miglior servizio di calcio in streaming in Europa?", a: "ATV Corner offre la copertura più completa: Serie A, Premier League, LaLiga, Bundesliga, Ligue 1, Champions League, Europa League, Mondiali ed Europei. Tutti i campionati europei in HD e 4K, senza blocco geografico, da 15 €/mese. Rispetto a DAZN (35 €) o Sky (40 €), l'opzione più economica e più completa." },
      { q: "Posso guardare la Premier League in italiano senza Sky?", a: "Sì. ATV Corner riunisce le trasmissioni della Premier League compresa la telecronaca in italiano. Accedi a tutte le 380 partite della stagione, comprese quelle del sabato alle 15 bloccate nel Regno Unito, in HD e 4K HDR." },
      { q: "ATV Corner funziona su Smart TV Samsung, LG e Sony, Fire Stick e Apple TV?", a: "Sì: app native per Smart TV (Smarters Pro, IBO Player), Fire TV Stick 4K Max (TiviMate), Apple TV 4K (Smarters Pro), Android TV (NVIDIA Shield, Xiaomi Mi Box, Chromecast con Google TV), iPhone, Android, Windows, macOS e browser Chrome, Safari e Firefox." },
      { q: "Che velocità internet serve per il calcio in 4K?", a: "Almeno 25 Mbps in download per un 4K HDR stabile, 8 Mbps per l'HD 1080p e 3 Mbps per l'SD 720p. Verifica la tua banda con il nostro strumento per sapere quale qualità regge la tua connessione." },
      { q: "Posso guardare più partite contemporaneamente?", a: "Sì. La modalità multivisione (mosaico a quattro quadranti) è disponibile su Fire TV Stick, Android TV, NVIDIA Shield e browser web. Ideale per le serate di Champions League con otto partite in parallelo o per la giornata di campionato." },
      { q: "Esiste una garanzia di rimborso?", a: "Sì, garanzia di rimborso di 7 giorni. C'è inoltre una prova gratuita di 24 ore via WhatsApp per verificare la qualità dello streaming dalla tua connessione prima di acquistare." },
    ],
  },
};
