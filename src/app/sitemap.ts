...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const paths = [
    ...
    { path: "/iptv-subscription", priority: 0.9, changeFrequency: "weekly" as const },
    ...
    { path: "/iptv-usa", priority: 0.9, changeFrequency: "weekly" as const },
    ...
    { path: "/iptv-espana", priority: 0.95, changeFrequency: "weekly" as const },
    { path: "/iptv-italia", priority: 0.95, changeFrequency: "weekly" as const },
